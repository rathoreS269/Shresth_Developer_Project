  ...
  return (
    ...
    {/* top */}
      ...
      <h1 className="text-5xl font-bold text-gray-800  " style={{
        ...
        Move Into Your Dream  <span className='text-gray-500'>Home</span>
      </h1>

       <div className='text-gray-500  font-bold text-s sm:text-m '>
         Shresth Developer is the best place to find your next
