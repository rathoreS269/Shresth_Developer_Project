...
function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      text-center my-7  '>Upload An Estate <span className='text-sm text-gray-800 ml-2'>only for admin</span></h1>
      <form className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className=' flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4 '>
              ...
              <input onChange={(e)=>setFiles(e.target.files)} type="file"  id='images'
              ...
              className='p-3 bg-green-700 border border-green-800 rounded uppercase hover:shadow-lg disabled:opacity-80' disabled={uploading}>
            ...
            <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>Upload Estate</button>
        </div>
